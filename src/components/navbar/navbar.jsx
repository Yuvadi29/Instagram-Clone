...
import pp1 from "../images/first.png"
    ...
    document.addEventListener("DOMContentLoaded", (event) => {
        ...
        p.addEventListener("click", () => {
            if (togglestatus === false) {
                document.querySelector(".drop-down").style.visibility =
                    "hidden";
                document
                    .querySelector("#home1")
                    .setAttribute(
                    ...
                    <div className="icons">
                        ...
                        <div className="profile-img">
                            ...
                            <div>
                                ...
                                >
                                    {            <Avatar style={{ "width": "30px", "height": "30px" ,"margin-top" : "-14px" }} src={pp1} className='nav_icon_element' />
}                                </span>
                                </Link>
                            </div>
                            {/* <!-- Profile icons ends  --> */}
